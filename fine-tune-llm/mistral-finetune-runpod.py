# %%
train_dataset='/workspace/mistral_finetune_dataset.jsonl'
...
model_name = "/workspace/mistral-7b"
...
training_args = TrainingArguments(
        ...
        fp16=True,
        logging_steps=1,
        output_dir="/workspace/food-blog-mistral-7b-checkpoints",
        max_steps=1000,
        save_total_limit = 2,
save_steps = 250,
...
trainer.model.save_pretrained("/workspace/food-blog-mistral-7b-finetune")
